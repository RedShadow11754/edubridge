...
export function StudentSignup() {
    ...
    let uGrade = useRef(null);
    let pass = useRef(null);
    const [serverError, setServerError] = useState("");

    async function onSubmit(e) {
        e.preventDefault();
        if (fName.current.value && lName.current.value && uEmail.current.value && pass.current.value && uGrade.current.value) {
